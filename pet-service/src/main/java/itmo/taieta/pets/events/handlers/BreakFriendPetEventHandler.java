...
public class BreakFriendPetEventHandler implements PetEventHandler {
    private final PetDtoMapper petDtoMapper;
    private final PetService petService;

    @Override
    public boolean canHandle(String event) {
        return PetEvents.BREAK_FRIEND.name().equals(event);
    }
    ...
    public void handle(EventRequest request,  EventResponse response) {
        ...
        Pet pet = petService.breakFriend(petId, friendId);
